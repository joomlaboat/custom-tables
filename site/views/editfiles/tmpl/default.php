...
<form action="index.php?Itemid=<?php echo $this->jinput->get('Itemid',0,'INT'); ?>" method="POST" name="eseditfiles" id="eseditfiles" enctype="multipart/form-data">
<?php
	$toolbar='
...
?>
	...
	<fieldset class="adminform" >
		...
		<tr>
			<td colspan="2">
				<?php echo JoomlaBasicMisc::JTextExtended( "COM_CUSTOMTABLES_PERMITTED_MAX_FILE_SIZE" ).': '.JoomlaBasicMisc::formatSizeUnits($this->max_file_size); ?><br/>
