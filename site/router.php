...
class CustomTablesRouter extends JComponentRouterView
{
	...
	protected function CheckIfFile2download(&$segments,&$vars)
	{
				...
				if(strpos(end($segments),'.')!==false)
				{
					...
					{
						//probably a file
						$allowedExtensions=explode(' ','gslides doc docx pdf txt xls xlsx psd ppt pptx mp3 wav ogg jpg bmp ico odg odp ods swf xcf jpeg png gif svg ai aac m4a wma flv mpg wmv mov flac txt avi csv accdb zip');
