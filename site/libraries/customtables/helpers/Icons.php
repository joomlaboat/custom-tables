...
class Icons
{
	public static function renderIconSet($type)
	{
		...
		<div id="ui-<?php echo($type === '' ? 'images' : $type); ?>" style="display: none;">
			<ul>
				...
				<li><?php echo common::translate('COM_CUSTOMTABLES_SEARCH') ?>
					: <?php echo Icons::iconSearch($type); ?></li>
				<li><?php echo common::translate('COM_CUSTOMTABLES_SEARCHRESET') ?>
	...
	{
		if (empty($title))
			$title = common::translate('COM_CUSTOMTABLES_SELECT_RESET');
	...
	{
		if (empty($title))
			$title = common::translate('COM_CUSTOMTABLES_START');
	...
	{
		if (empty($title))
			$title = common::translate('COM_CUSTOMTABLES_END');
