...
');
	...
	public static function getLocalizeScriptArray()
	{
		return [
			...
			'COM_CUSTOMTABLES_DRAG_DROP_FILES' => self::translate('COM_CUSTOMTABLES_DRAG_DROP_FILES'),
			'COM_CUSTOMTABLES_UPLOAD_FILE' => self::translate('COM_CUSTOMTABLES_UPLOAD_FILE'),
			'COM_CUSTOMTABLES_ABORT' => self::translate('COM_CUSTOMTABLES_ABORT'),
			'COM_CUSTOMTABLES_CANCEL' => self::translate('COM_CUSTOMTABLES_CANCEL'),
			'COM_CUSTOMTABLES_DELETE' => self::translate('COM_CUSTOMTABLES_DELETE'),
			'COM_CUSTOMTABLES_DONE' => self::translate('COM_CUSTOMTABLES_DONE'),
			'COM_CUSTOMTABLES_MULTIPLE_DRAG_DROP_FILES' => self::translate('COM_CUSTOMTABLES_MULTIPLE_DRAG_DROP_FILES'),
			'COM_CUSTOMTABLES_ALLOWED_EXTENSIONS' => self::translate('COM_CUSTOMTABLES_ALLOWED_EXTENSIONS'),
			'COM_CUSTOMTABLES_FILE_ALREADY_EXISTS' => self::translate('COM_CUSTOMTABLES_FILE_ALREADY_EXISTS'),
			'COM_CUSTOMTABLES_ALLOWED_MAX_SIZE' => self::translate('COM_CUSTOMTABLES_ALLOWED_MAX_SIZE'),
			'COM_CUSTOMTABLES_UPLOAD_NOT_ALLOWED' => self::translate('COM_CUSTOMTABLES_UPLOAD_NOT_ALLOWED'),
			'COM_CUSTOMTABLES_MAX_ALLOWED_FILES' => self::translate('COM_CUSTOMTABLES_MAX_ALLOWED_FILES'),
			'COM_CUSTOMTABLES_DOWNLOAD' => self::translate('COM_CUSTOMTABLES_DOWNLOAD')
		];
	}
