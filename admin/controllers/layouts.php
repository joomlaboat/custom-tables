 ...
 * Layouts Controller
 */
class CustomtablesControllerLayouts extends JControllerForm
{
    /**
    ...
    public function batch($model = null)
    {
        ...
        // Preset the redirect
        $this->setRedirect(JRoute::_('index.php?option=com_customtables&view=listoflayouts' . $this->getRedirectToListAppend(), false));
