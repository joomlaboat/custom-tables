...
function getESTables()
{
	...
	function fixNewCTTables($mysqltable)
	{
		...
		$ads[]='`params` TEXT NOT NULL AFTER `asset_id`';
	...
	*/
	...
	function updateFields($new_tablename)
	{
		...
		if($new_tablename==$dbprefix.'customtables_tables')
			{
				ESFields::AddMySQLFieldNotExist($new_tablename, 'asset_id', 'INT(10) unsigned NOT NULL DEFAULT 0', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'params', 'text NOT NULL DEFAULT ""', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'published', 'TINYINT(3) NOT NULL DEFAULT 1', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'created_by', 'INT(10) unsigned NOT NULL DEFAULT 0', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'modified_by', 'INT(10) unsigned NOT NULL DEFAULT 0', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'created', 'DATETIME NOT NULL DEFAULT "0000-00-00 00:00:00"', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'modified', 'DATETIME NOT NULL DEFAULT "0000-00-00 00:00:00"', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'checked_out', 'int(11) unsigned NOT NULL DEFAULT 0', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'checked_out_time', 'DATETIME NOT NULL DEFAULT "0000-00-00 00:00:00"', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'version', 'INT(10) unsigned NOT NULL DEFAULT 1', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'hits', 'INT(10) unsigned NOT NULL DEFAULT 0', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'ordering', 'INT(11) NOT NULL DEFAULT 0', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'tablecategory', 'INT(11) NOT NULL DEFAULT 0', '');
			...
			elseif($new_tablename==$dbprefix.'customtables_fields')
			{
				...
				ESFields::AddMySQLFieldNotExist($new_tablename, 'description', 'VARCHAR(1024) NOT NULL DEFAULT ""', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'isdisabled', 'tinyint(1) NOT NULL default "0"', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'phponadd', 'text NULL', '');
				ESFields::AddMySQLFieldNotExist($new_tablename, 'phponchange', 'text NULL', '');
			}
