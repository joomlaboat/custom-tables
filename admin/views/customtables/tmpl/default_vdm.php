...
?>
<img alt="<?php echo JText::_('COM_CUSTOMTABLES'); ?>"
...
<ul class="list-striped">
    <li><b><?php echo JText::_('COM_CUSTOMTABLES_VERSION'); ?>:</b> <?php echo $this->manifest->version; ?>
        &nbsp;&nbsp;<span class="update-notice"></span></li>
    <li><b><?php echo JText::_('COM_CUSTOMTABLES_DATE'); ?>:</b> <?php echo $this->manifest->creationDate; ?></li>
    <li><b><?php echo JText::_('COM_CUSTOMTABLES_AUTHOR'); ?>:</b> <a
                href="mailto:<?php echo $this->manifest->authorEmail; ?>"><?php echo $this->manifest->author; ?></a>
    </li>
    <li><b><?php echo JText::_('COM_CUSTOMTABLES_WEBSITE'); ?>:</b> <a href="<?php echo $this->manifest->authorUrl; ?>"
